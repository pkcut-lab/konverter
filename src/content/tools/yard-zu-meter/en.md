---
toolId: yard-to-meter
language: en
title: "Yards to Meters Converter — Fast & Exact"
headingHtml: "Yards to <em>Meters</em> — Instant Conversion"
metaDescription: "Convert yards to meters instantly. Exact formula: 1 yard = 0.9144 m. Built for football fields, fabric, pools, and golf. No rounding errors."
tagline: "Convert yards to meters (and meters to yards) with exact precision. Covers American football, fabric, swimming pools, golf courses, and more."
intro: "One yard equals exactly 0.9144 meters — a fixed, internationally agreed conversion defined in 1959 by the International Yard and Pound Agreement. This tool converts yards to meters and meters to yards with full decimal precision, no rounding errors. Whether you're converting an American football field to metric, calculating fabric for a sewing project, or comparing pool lengths, the result is exact every time."
howToUse:
...
faq:
  - q: "What is the exact conversion factor from yards to meters?"
    a: "1 yard = 0.9144 meters exactly. This is not an approximation — it is a defined legal equivalence established in 1959 by the United States, United Kingdom, Australia, and other Commonwealth nations. The inverse is 1 meter = 1.0936132983... yards."
  - q: "How many meters is a standard American football field?"
    a: "A regulation NFL field is 100 yards long, which equals exactly 91.44 meters. Including the two end zones (10 yards each), the total field length is 120 yards = 109.728 meters."
  - q: "How do yards and meters compare in swimming pools?"
    a: "A standard short-course pool in the US is 25 yards (22.86 m). A short-course metric pool is 25 meters (27.34 yards). An Olympic pool is 50 meters (54.68 yards). Records set in yard pools and meter pools are tracked separately in competitive swimming."
  - q: "Is a yard longer or shorter than a meter?"
    a: "Shorter. One yard is 0.9144 meters, so a yard is about 8.56% shorter than a meter. Equivalently, 1 meter is about 9.36% longer than 1 yard."
  - q: "How is the yard used in fabric and textiles?"
    a: "In the US, fabric is sold by the yard. Common purchases are 1 yard (0.91 m), 1.5 yards (1.37 m), or 2 yards (1.83 m). Patterns specify yardage; if you are using a metric pattern, multiply meters by 1.0936 to get the yards to purchase."
relatedTools:
  - meter-to-feet
  - feet-to-meters
  - km-to-miles
...
**How do I convert a speed given in yards per second to meters per second?**
Multiply by 0.9144. For example, 10 yards per second = 9.144 meters per second. For yards per minute, the factor is the same — 0.9144 meters per minute per yard per minute.

**What is a square yard in square meters?**
One square yard = 0.9144² = 0.83612736 square meters. To convert square yards to square meters, multiply by 0.83612736. This comes up frequently with carpet, flooring, and turf area calculations.
