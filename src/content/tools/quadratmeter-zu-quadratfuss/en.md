...
headingHtml: "Convert <em>square meters to square feet</em>"
metaDescription: "Convert square meters to square feet instantly — exact formula (1 m² = 10.7639 ft²), US room size and apartment listing reference table. Completely free."
tagline: "Enter any area in square meters and get the square foot equivalent immediately — with a US apartment and room size reference table."
intro: "Shopping for an apartment listed in square meters on a foreign site? Comparing a US home to a European property? Ordering flooring from an international supplier? The kittokit m² to ft² converter gives you the instant, exact conversion — plus a US room size reference table so the number actually means something."
howToUse:
  - "Enter the area in square meters (m²) in the input field."
  - "The equivalent in square feet (ft²) appears instantly as you type."
  - "Use the swap button to convert square feet back to square meters."
  - "Scroll to the reference table to compare against common US room and apartment sizes."
faq:
  - q: "What is the exact conversion formula?"
    a: "1 m² = 10.7639104 ft². The tool uses the full-precision factor derived from the international foot definition (1 ft = 0.3048 m exactly)."
  - q: "How many square feet is 100 m²?"
    a: "100 m² = 1,076.39 ft². A 100 m² apartment is considered a spacious 2–3 bedroom in US terms."
  - q: "How many square feet is 50 m²?"
    a: "50 m² = 538.2 ft². That corresponds to a compact studio or small one-bedroom apartment in a US city."
  - q: "How do I convert square feet to square meters?"
    a: "Divide by 10.7639, or multiply by 0.092903. Use the swap button on this tool for instant reverse conversion."
  - q: "What is the average size of a US home in square meters?"
    a: "The average new single-family home in the US is about 2,300 ft² = 213.7 m². The median existing home is around 1,800 ft² = 167.2 m²."
relatedTools:
  - meter-to-feet
  - hectares-to-acres
...
| m² | ft² | US reference |
|----|-----|-------------|
| 20 | 215 | A large master bedroom |
| 30 | 323 | A small studio apartment |
| 50 | 538 | A compact 1-bedroom city apartment |
| 75 | 807 | A typical 1-bedroom apartment |
| 100 | 1,076 | A spacious 2-bedroom apartment |
| 150 | 1,615 | A 3-bedroom townhouse |
| 200 | 2,153 | A mid-size single-family home |
| 300 | 3,229 | A large suburban home |
| 465 | 5,005 | ~1 acre footprint building |
...
| Room type | Typical US size (ft²) | Equivalent (m²) |
|-----------|----------------------|----------------|
| Master bedroom | 200–350 ft² | 18.6–32.5 m² |
| Standard bedroom | 120–200 ft² | 11.1–18.6 m² |
| Living room | 250–400 ft² | 23.2–37.2 m² |
| Kitchen | 100–200 ft² | 9.3–18.6 m² |
| Bathroom (full) | 40–80 ft² | 3.7–7.4 m² |
| Studio apartment | 300–600 ft² | 27.9–55.7 m² |
| 1-bedroom apartment | 600–900 ft² | 55.7–83.6 m² |
