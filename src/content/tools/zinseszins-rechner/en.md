...
language: en
title: "Compound Interest Calculator — 401(k) & Savings"
headingHtml: "Compound Interest Calculator — <em>Watch Your Money Grow</em>"
metaDescription: "Calculate compound interest with yearly, monthly, or daily compounding. See 401(k), IRA, and savings growth over time. Includes Rule of 72. Free tool."
tagline: "Enter principal, interest rate, time, and compounding frequency to see exactly how your money grows. Covers savings accounts, 401(k) and IRA projections, and CDs. Includes the Rule of 72 shortcut."
intro: "Compound interest is interest earned on both the original principal and the accumulated interest from previous periods. Over long time horizons, the difference between simple and compound interest is dramatic — a 7% annual return on $10,000 yields $19,672 after 10 years with compound interest versus $17,000 with simple interest. This calculator shows you the full picture: total value, total interest earned, and a year-by-year breakdown of growth."
howToUse:
  - "Enter your starting principal (the initial amount invested or deposited)."
  ...
  - "Optionally add a regular contribution (monthly or annually) — the results show final balance, total interest earned, and a year-by-year breakdown."
faq:
  - q: "What is the compound interest formula?"
    a: "The standard formula is A = P(1 + r/n)^(nt), where A is the final amount, P is the principal, r is the annual interest rate as a decimal, n is the number of compounding periods per year, and t is the time in years. For example, $5,000 at 6% compounded monthly for 10 years: A = 5000 × (1 + 0.06/12)^(12×10) = 5000 × (1.005)^120 = $9,096.98."
  - q: "What is the Rule of 72?"
    a: "The Rule of 72 is a mental math shortcut: divide 72 by the annual interest rate to estimate how many years it takes to double your money. At 6%, money doubles in roughly 72 ÷ 6 = 12 years. At 10%, it doubles in about 7.2 years. The rule works best for rates between 2% and 20% and gives results accurate to within a year or two."
  - q: "What is the historical average return of the S&P 500?"
    a: "The S&P 500 has averaged approximately 10% annually before inflation over long periods (1926–present). Adjusted for inflation, the real return is roughly 7%. These are historical averages — individual years vary widely, with some years returning 30%+ and others losing 30%+. Most retirement planning tools use 6–7% as a conservative real-return estimate."
  - q: "How does compounding frequency affect the final amount?"
    a: "More frequent compounding produces slightly more interest because each period's interest begins earning interest sooner. For a $10,000 deposit at 5% for 10 years: annually compounded = $16,288.95; monthly compounded = $16,470.09; daily compounded = $16,486.65. The difference between monthly and daily compounding is small; the big jump is from annual to monthly."
  - q: "How does compound interest apply to 401(k) plans?"
    a: "A 401(k) grows through compound returns on investments (typically stock and bond funds), not a fixed interest rate. The mechanism is the same — returns compound over time — but the rate varies year to year. Most projections use a blended average (often 6–7% after fees). The 401(k) contribution limit in 2025 is $23,500 ($31,000 if 50 or older with catch-up contributions)."
  - q: "What is a CD (Certificate of Deposit) and how is interest calculated?"
    a: "A CD is a bank deposit product with a fixed interest rate and a fixed term (typically 3 months to 5 years). The rate is guaranteed for the term. CDs typically compound daily or monthly. In 2024–2025, 1-year CD rates from top online banks ranged from 4.5% to 5.5% APY. APY (Annual Percentage Yield) already accounts for compounding — it represents the effective annual rate."
relatedTools:
  - interest-calculator
  - loan-calculator
