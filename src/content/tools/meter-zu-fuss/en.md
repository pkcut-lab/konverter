...
language: en
title: "Meters to Feet Converter — m to ft and Back"
headingHtml: "Convert <em>meters to feet</em> (and feet to meters) with full precision"
metaDescription: "Convert meters to feet or feet to meters instantly. Includes the exact formula, a reference table, and US use cases for height, buildings, and rooms."
tagline: "Type meters to get feet, or feet to get meters — both directions, instant, precise. Includes a conversion table and practical reference points for US everyday use."
intro: "The meter is the world's base unit of length, but the United States uses feet for almost everything — building heights, room dimensions, elevation, and human height. This converter handles both directions with full precision and includes a reference table with the measurements Americans encounter most often."
howToUse:
  - "Type a value in the Meters field to convert to feet — result appears instantly."
  - "Or type a value in the Feet field to convert back to meters."
  - "For height in feet and inches (e.g. 5'10\"), use the feet+inches mode: enter whole feet and remaining inches separately."
  - "Refer to the conversion table for quick reference on common measurements."
faq:
  - q: "How many feet are in a meter?"
    a: "Exactly 3.28084 feet (3 feet 3.3701 inches). The exact conversion factor is 1 meter = 100/30.48 feet, since 1 inch = 25.4 mm exactly and 1 foot = 12 inches."
  - q: "How tall is 6 feet in meters?"
    a: "6 feet = 1.8288 meters. For quick mental math: 6 ft × 0.3048 = 1.8288 m. Common US male height benchmarks: 5'9\" = 1.75 m, 5'11\" = 1.80 m, 6'0\" = 1.83 m, 6'2\" = 1.88 m."
  - q: "How do I convert meters to feet and inches?"
    a: "First multiply meters by 3.28084 to get total feet as a decimal. Then take the integer part as whole feet and multiply the decimal remainder by 12 to get inches. Example: 1.75 m × 3.28084 = 5.7414 ft → 5 feet, 0.7414 × 12 = 8.9 inches → 5'9\"."
  - q: "What is the difference between feet and meters for building heights?"
    a: "US architects and real estate listings use feet. One floor of a typical US commercial building is about 12–14 feet (3.7–4.3 m). A 100-foot building is about 30.5 m tall."
  - q: "How many meters is a football field?"
    a: "An American football field is 100 yards = 300 feet = 91.44 meters (including the end zones: 360 feet = 109.73 m). The field itself (goal line to goal line) is exactly 91.44 m."
relatedTools:
  - cm-to-inches
  - km-to-miles
  - sqm-to-sqft
...
|--------|------|---------------|
| 0.5 m | 1.640 ft | 1' 7.7" |
| 1.0 m | 3.281 ft | 3' 3.4" |
| 1.5 m | 4.921 ft | 4' 11.1" |
| 1.6 m | 5.249 ft | 5' 3.0" |
| 1.7 m | 5.577 ft | 5' 6.9" |
| 1.75 m | 5.741 ft | 5' 8.9" |
| 1.8 m | 5.906 ft | 5' 10.9" |
| 1.83 m | 6.004 ft | 6' 0.0" |
| 2.0 m | 6.562 ft | 6' 6.7" |
| 3.0 m | 9.843 ft | 9' 10.1" |
| 5.0 m | 16.404 ft | 16' 4.9" |
