...
language: en
title: "Car Lease Payment Calculator — Money Factor"
headingHtml: "Calculate your <em>monthly lease payment</em> from MSRP and money factor"
metaDescription: "Calculate monthly car lease payments using MSRP, residual value, and money factor. Converts money factor to APR. Free, instant, no login needed."
tagline: "Enter the vehicle MSRP, residual value, money factor, and any cap cost reductions — get your exact monthly lease payment before stepping into a dealership."
intro: "Car leases in the US are priced using a money factor instead of a traditional APR, which makes them harder to evaluate at a glance. This calculator translates the dealer's money factor into a monthly payment you can verify — and converts money factor to APR so you can compare the lease cost against a loan."
howToUse:
  - "Enter the vehicle MSRP (sticker price) and the negotiated selling price (capitalized cost)."
  - "Enter any cap cost reductions: down payment, rebates, or trade-in value."
  - "Enter the residual value — the vehicle's projected value at lease end, stated as a dollar amount or percentage of MSRP."
  - "Enter the money factor (e.g. 0.00125). If the dealer gives you a rate, divide it by 2,400 to convert APR to money factor."
  - "Enter the lease term in months (typically 24, 36, or 39 months) and click Calculate."
faq:
  - q: "What is a money factor in a car lease?"
    a: "Money factor is the financing cost of a lease, expressed as a small decimal (e.g. 0.00125). Multiply it by 2,400 to convert to an approximate APR. A money factor of 0.00125 equals roughly 3.0% APR."
  - q: "What is a good money factor?"
    a: "Money factor varies by lender and model. As a rule, anything below 0.0020 (4.8% APR equivalent) is competitive. Captive lenders (manufacturer finance arms like BMW Financial, Toyota Financial) publish base money factors monthly — markups above the base are dealer profit."
  - q: "What is residual value and why does it matter?"
    a: "Residual value is the lender's estimate of the car's worth at lease end. A higher residual means you are financing less depreciation, resulting in a lower monthly payment. Residuals are set by the lender, not negotiable."
  - q: "Can I negotiate the money factor?"
    a: "Yes. Dealers can mark up the base money factor (published by the captive lender) by up to 0.00100 in many programs. Always ask for the 'buy rate' or look up the current money factor on lease forums before negotiating."
  - q: "What happens if I put money down on a lease?"
    a: "A down payment (cap cost reduction) lowers your monthly payment but provides no refund if the vehicle is totaled or stolen. Financial advisors generally recommend minimizing down payments on leases for this reason."
  - q: "Is this calculator accurate for all lease types?"
    a: "It uses the standard US closed-end lease formula. It does not account for acquisition fees, disposition fees, or taxes, which vary by state and lender. Add those to your total monthly estimate."
relatedTools:
  - loan-calculator
  - interest-calculator
...
| Term | Meaning |
|------|---------|
| Adjusted Cap Cost | Negotiated price − cap cost reductions (down payment, rebates, trade-in) |
| Residual Value | Projected vehicle value at lease end |
| Money Factor | Lease financing rate (APR ÷ 2,400) |
| Lease Term | Number of months (typically 24–48) |
