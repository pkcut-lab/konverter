...
language: en
title: "Liters to Gallons Converter — US & Imperial"
headingHtml: "Convert <em>liters to US gallons</em> instantly with the exact formula"
metaDescription: "Convert liters to US gallons (and gallons to liters) instantly. Covers US liquid gallons, Imperial gallons, fuel tanks, water jugs, and pool volume."
tagline: "Enter any value in liters or US gallons and get an instant, precise conversion. Includes a quick-reference table for common volumes and both US and Imperial gallon definitions."
intro: "The liter is the world's standard unit for liquid volume, but the United States uses gallons for fuel, water, and most everyday liquids. Whether you're comparing a European car's fuel economy, filling a water container, or calculating pool capacity, this converter gives you the exact figure in one step."
howToUse:
...
faq:
  - q: "How many liters are in a US gallon?"
    a: "Exactly 3.785411784 liters. For most practical purposes, 1 US gallon ≈ 3.785 L."
  - q: "What is the difference between a US gallon and an Imperial gallon?"
    a: "A US liquid gallon is 3.785 L. A British Imperial gallon is 4.546 L — about 20% larger. If you see fuel economy stated in miles per gallon for a British or Australian vehicle, the gallon used is Imperial, not US."
  - q: "How many gallons is a standard US gas tank?"
    a: "Most passenger cars hold 12–16 US gallons. Trucks and SUVs typically range from 20–36 gallons. A compact car like a Honda Civic holds about 12.4 gallons (46.9 L)."
  - q: "How do I convert L/100 km to mpg?"
    a: "For US mpg: divide 235.21 by the L/100 km figure. A car rated 7.0 L/100 km gets approximately 235.21 ÷ 7.0 ≈ 33.6 US mpg."
  - q: "How many gallons is a standard water jug?"
    a: "The classic US water cooler jug holds 5 US gallons (18.9 L). Water heaters are commonly rated in gallons: 30, 40, 50, and 80-gallon tanks are the most common residential sizes."
relatedTools:
  - ml-to-fluid-ounces
  - kg-to-lbs
  - km-to-miles
