...
language: "de"
title: "Erbschaftsteuer Rechner 2026 — Freibetrag und Tarif"
metaDescription: "Erbschaftsteuer 2026 berechnen: Freibetrag, Steuerklasse, Härteausgleich, Familienheim und Vorschenkungen. Kostenlos, ohne Anmeldung, lokal im Browser."
tagline: "Erbschaftsteuer nach Freibetrag, Steuerklasse und Härteausgleich §24 ErbStG"
intro: "Berechne die Erbschaftsteuer 2026 nach aktueller Rechtslage — mit persönlichem Freibetrag §16, Versorgungsfreibetrag §17, Härteausgleich §24 und Vorschenkungs-Anrechnung §14. Alle Eingaben bleiben im Browser."
category: "finance"
contentVersion: 1
headingHtml: "<em>Erbschaftsteuer</em> Rechner"
howToUse:
  - "Wähle das Verwandtschaftsverhältnis — Steuerklasse und persönlicher Freibetrag werden automatisch zugewiesen."
  - "Gib den Brutto-Nachlasswert in Euro ein und ergänze optional Schulden, Familienheim oder Mietwohnimmobilie."
  - "Trage Vorschenkungen aus den letzten zehn Jahren ein, falls vorhanden — sie werden nach §14 ErbStG angerechnet."
  - "Lies Erbschaftsteuer, Freibetrag und Netto-Erbe direkt ab und kopiere die Zusammenfassung für dein Steuerberater-Gespräch."
faq:
  - q: "Wie hoch ist der Freibetrag für Ehepartner 2026?"
    a: "Der persönliche Freibetrag für Ehepartner und eingetragene Lebenspartner beträgt nach §16 Abs. 1 Nr. 1 ErbStG 500.000 Euro. Hinzu kommt ein Versorgungsfreibetrag von 256.000 Euro nach §17 Abs. 1 ErbStG. Beide Freibeträge sind kumulativ und werden vom steuerpflichtigen Erwerb abgezogen, bevor der Tarif greift."
  - q: "Welche Steuerklasse gilt bei welchem Verwandtschaftsverhältnis?"
    a: "Steuerklasse I (Tarif 7–30 Prozent) gilt für Ehepartner, Lebenspartner, Kinder, Enkel, Eltern und Großeltern bei Erwerb von Todes wegen. Steuerklasse II (15–43 Prozent) umfasst Geschwister, Nichten, Neffen und Schwiegereltern. Steuerklasse III (30 oder 50 Prozent) gilt für alle übrigen Erwerber, also nicht verwandte Personen."
  - q: "Was ist der Härteausgleich nach §24 ErbStG?"
    a: "Wird durch einen leichten Bandübertritt eine Steuersatzstufe überschritten, würde die zusätzliche Steuer den Mehrerwerb übersteigen. §24 ErbStG begrenzt diese Mehrbelastung: Der Steuersatz auf den Mehrerwerb über die Bandgrenze beträgt höchstens 50 Prozent. Beispiel Steuerklasse I: 80.000 Euro steuerpflichtiger Erwerb ergeben 7.750 Euro Steuer statt 8.800 Euro ohne Härteausgleich."
  - q: "Wie wirkt sich das Familienheim auf die Erbschaftsteuer aus?"
    a: "Nach §13 Abs. 1 Nr. 4b ErbStG ist das vom Erblasser bewohnte Familienheim steuerfrei, wenn der Erbe es zehn Jahre selbst nutzt. Bei Kindern gilt eine Wohnflächengrenze von 200 Quadratmetern, darüber hinausgehende Fläche ist steuerpflichtig. Ehepartner haben keine Flächenbegrenzung."
  - q: "Wie werden Vorschenkungen nach §14 ErbStG angerechnet?"
    a: "Schenkungen innerhalb der letzten zehn Jahre vor dem Erbfall werden mit dem Erbe zusammengezählt. Der Freibetrag wird nur einmal gewährt — überschritt eine Vorschenkung den Freibetrag, ist die bereits gezahlte Schenkungsteuer auf die Erbschaftsteuer anrechenbar. Der Rechner zieht die Vorschenkungs-Steuer nach §14 ErbStG automatisch ab."
  - q: "Sind meine Eingaben vertraulich?"
    a: "Ja. Alle Berechnungen laufen vollständig im Browser, keine Daten werden an Server übertragen. Es gibt keine Anmeldung, kein Tracking und keine Cookies für den Rechner. Hinweis: Dieser Rechner ersetzt keine Steuerberatung — verbindliche Auskünfte erteilt das Finanzamt."
relatedTools: ['cashflow-rechner', 'leasing-faktor-rechner', 'kgv-rechner']
---
...
## Versorgungsfreibetrag und Härteausgleich
...
## Familienheim und Mietwohnimmobilien
...
- **[Leasing-Faktor-Rechner](/de/leasing-faktor-rechner)** — Leasingangebot mit Sonderzahlung-Bereinigung gegen Marktdurchschnitt 0,63 vergleichen.
- **[KGV-Rechner](/de/kgv-rechner)** — Kurs-Gewinn-Verhältnis mit Branchen-Benchmarks und historischer Einordnung berechnen.
