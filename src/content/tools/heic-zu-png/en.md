...
metaDescription: "Convert HEIC and HEIF files to lossless PNG in your browser — no server upload, no tracking, GDPR-compliant by design. Perfect for web design, screenshots, and images requiring transparency."
