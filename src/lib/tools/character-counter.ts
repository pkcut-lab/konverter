...
export const characterCounter: AnalyzerConfig = {
  ...
  categoryId: 'text',
  metrics: [
    { id: 'chars', label: { de: 'Zeichen', en: 'Characters' } },
    { id: 'chars-no-spaces', label: { de: 'Zeichen (ohne Leerzeichen)', en: 'Characters (no spaces)' } },
    { id: 'words', label: { de: 'Wörter', en: 'Words' } },
    { id: 'sentences', label: { de: 'Sätze', en: 'Sentences' } },
    { id: 'paragraphs', label: { de: 'Absätze', en: 'Paragraphs' } },
    { id: 'lines', label: { de: 'Zeilen', en: 'Lines' } },
    { id: 'reading-time', label: { de: 'Lesezeit', en: 'Reading time' } },
  ],
  placeholder: {
    de: 'Text hier einfügen — Zeichen, Wörter und Lesezeit werden live gezählt.',
    en: 'Paste text here — characters, words and reading time counted live.',
  },
};
