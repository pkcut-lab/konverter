...
describe('quadratmeter-zu-quadratfuss/de.md frontmatter', () => {
  const filePath = resolve(__dirname, '../../src/content/tools/quadratmeter-zu-quadratfuss/de.md');
  ...
  it('toolId matches slug-map entry', () => {
    expect(parsed.data.toolId).toBe('sqm-to-sqft');
