...
describe('kilometer-zu-meilen/de.md frontmatter', () => {
  const filePath = resolve(__dirname, '../../src/content/tools/kilometer-zu-meilen/de.md');
  ...
  it('toolId matches slug-map entry', () => {
    expect(parsed.data.toolId).toBe('km-to-mile');
