...
describe('zentimeter-zu-zoll/de.md frontmatter', () => {
  const filePath = resolve(__dirname, '../../src/content/tools/zentimeter-zu-zoll/de.md');
  ...
  it('toolId matches slug-map entry', () => {
    expect(parsed.data.toolId).toBe('cm-to-inch');
