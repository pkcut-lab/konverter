...
describe('celsius-zu-fahrenheit/de.md frontmatter', () => {
  const filePath = resolve(__dirname, '../../src/content/tools/celsius-zu-fahrenheit/de.md');
  ...
  it('toolId matches slug-map entry', () => {
    expect(parsed.data.toolId).toBe('celsius-to-fahrenheit');
