...
|---|---|---|---|---|---|
<!-- CEO-APPEND -->
| [sprache-verbessern](https://konverter-7qc.pages.dev/de/sprache-verbessern) | text | shipped | 2026-04-25 | [dev](http://localhost:4322/de/sprache-verbessern) | 3-Pass End-Review clean (KON-469 P1 re-check CEO§0.7 CLEAN commit 5132d15, KON-481 P2 clean, KON-485 P3 clean commit 4ad6d0e); B-01 spot-fix KON-478 (ONNX tensor assertion); 3×Rework (R1 KON-444, R2 KON-455, R3 KON-455 4×de.md edits); Pipeline: KON-92 build → 8 R1 Critics → KON-414 Meta-R1 → Rework-R2 KON-444 → 8 R2 Critics → KON-453 Meta-R2 → Rework-R3 KON-455 → 8 R3 Critics → KON-467 Meta-R3 SHIP-READY (§0.7 false-fail override) |
